<div class="tab-pane fade active in" id="sachkinhte">
     <ul class="list1 clearfix">
        @foreach($bookcategory3 as $bc)
                <li>
    ...
    <div>
        <p align="right"><a href="danh-muc-3" title="Truyện tranh" class="viewmore">Xem tất cả &gt;&gt;</a>
        </p>
    </div>
</div>