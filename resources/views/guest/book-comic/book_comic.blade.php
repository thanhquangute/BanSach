<div class="tab-pane fade active in" id="truyentranh">
     <ul class="list1 clearfix">
        @foreach($bookcategory1 as $bc)
    ...
    <div>
        <p align="right"><a href="danh-muc-1" title="Truyện tranh" class="viewmore">Xem tất cả &gt;&gt;</a>
        </p>
    </div>
</div>