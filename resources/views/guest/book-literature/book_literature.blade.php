<div class="tab-pane fade active in" id="sachvanhoc">
     <ul class="list1 clearfix">
        @foreach($bookcategory2 as $bc)
    ...
    <div>
        <p align="right"><a href="danh-muc-2" title="Truyện tranh" class="viewmore">Xem tất cả &gt;&gt;</a>
        </p>
    </div>
</div>